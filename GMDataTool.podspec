...
Pod::Spec.new do |s|
  s.name             = 'GMDataTool'
  s.version          = '0.1.0'
  s.summary          = 'A short description of GMDataTool.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ioszhanghui@163.com/GMDataTool'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ioszhanghui@163.com' => 'yomingyo@gmail.com' }
  s.source           = { :git => 'https://github.com/ioszhanghui@163.com/GMDataTool.git', :tag => s.version.to_s }
